...
$c_LMainApp$.prototype.main__V = (function() {
  ...
  this$3.java$lang$JSConsoleBasedPrintStream$$printString__T__V("Starting 'uuidgen'...\n");
  var p = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createElement("p");
  var text = $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().createTextNode(("id=" + $m_ju_UUID$().randomUUID__ju_UUID()));
  p.appendChild(text);
  $m_Lorg_scalajs_dom_package$().document__Lorg_scalajs_dom_raw_HTMLDocument().body.appendChild(p)
});
...
//# sourceMappingURL=uuidgen-fastopt.js.map
